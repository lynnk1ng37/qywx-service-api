...
import com.qq.qywx.api.addressbook.user.GetUser;
...
public class TestGetUser extends BaseTest {
    ...
    GetUser getUser = ProxyUtils.create(GetUser.class);

    // 当前接口编号，用来取出数据库中对应的测试用例数据
    private static String api_id = "user_get_1";
    ...
    public void testGetUser(String case_id, String api_id, String query_param, String query_body, Integer expected_code,
        ...
        if (!Objects.isNull(query_param)) {
            ...
            expected_targeted = expected_targeted.replace("${userid}", GlobalVar.useridlist.get(0));
        }
        ...
        response = getUser.getUser(query_param);
        // 断言
