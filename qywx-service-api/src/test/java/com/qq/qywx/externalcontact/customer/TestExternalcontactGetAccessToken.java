...
public class TestExternalcontactGetAccessToken extends BaseTest {

    GetAccessToken getAccessToken = ProxyUtils.create(GetAccessToken.class);

    // 当前接口编号，用来取出数据库中对应的测试用例数据
    private static String api_id = "externalcontact_gettoken_1";
    ...
    public void testExternalcontactGetAccessToken(String case_id, String api_id, String query_param, String query_body, Integer expected_code,
