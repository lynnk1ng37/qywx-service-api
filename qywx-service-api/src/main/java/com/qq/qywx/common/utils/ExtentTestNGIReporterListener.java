...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    private static final String FILE_NAME = "接口自动化测试报告_" + formatter.format(System.currentTimeMillis()) + ".html";
...
//                String description = result.getMethod().getDescription();
                ...
                String name = result.getMethod().getMethodName() + "(" + description + ")";
                if (extenttest == null) {
